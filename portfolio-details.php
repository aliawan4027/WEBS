...
if(isset($_GET['id'])){
    ...
    // Prepare and execute the query to fetch portfolio details using prepared statements
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        $category_sql = "SELECT * FROM `category` WHERE `id` = 1";
        $stmt_category = mysqli_prepare($con, $category_sql);
        ...
        if(mysqli_num_rows($category_result) > 0) {
            ...
            $category_data = array('name' => 'N/A');
        }
    } else {
        // Handle the case where portfolio data is not found
        // You might redirect the user to an error page or show a message
